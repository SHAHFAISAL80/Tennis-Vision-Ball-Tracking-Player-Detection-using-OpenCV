...
clip = VideoWriter(r'C:\Users\Atif Traders\Downloads\TRACE-main\video\tenis.mp4',fourcc,25.0,(widthP,heightP))
processedFrame = None
...
ball_detector = BallDetector(r'C:\Users\Atif Traders\Downloads\TRACE-main\TrackNet\Weights.pth', out_channels=2)
ballProximity = []
ball = None
lastSeen = None
handPoints = None
...
clip = VideoWriter(r'C:\Users\Atif Traders\Downloads\TRACE-main\video\tenis.mp4',fourcc,25.0,(widthP,heightP))
counter = 0
video = VideoCapture(r'C:\Users\Atif Traders\Downloads\TRACE-main\video\tenis.mp4')
writeFlag = False
while video.isOpened():
    ret, frame = video.read()
    if frame is None:
